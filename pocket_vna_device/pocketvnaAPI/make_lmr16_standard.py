...
print( 'This script takes LMR16 Calibration Standards and Measurement. This is done to guaranty all standards and measurements to have the same frequency' )
